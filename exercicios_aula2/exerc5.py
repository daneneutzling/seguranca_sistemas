def exerc5():
    ...
    # a good glass in the bishops hostel in the devils seat twenty one degrees and thirteen minutes northe a stand by north main branch seventh lim beast side 
    # shoot from the left eye of the deaths head a bee line from the tree throught he shot fifty feet out
